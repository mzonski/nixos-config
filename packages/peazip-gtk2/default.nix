...
stdenv.mkDerivation rec {
  ...
  buildPhase = ''
    ...
    lazbuild --lazarusdir=${lazarus}/share/lazarus --widgetset=gtk2 --build-all project_pea.lpi
    lazbuild --lazarusdir=${lazarus}/share/lazarus --widgetset=gtk2 --build-all project_peach.lpi
    popd
  '';
