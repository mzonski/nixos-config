# https://github.com/yunfachi/denix/blob/cbd8b8e09b64cedad7380a34abe8a3a4e332a561/lib/extensions/base/hosts.nix
{ delib, lib, ... }:
delib.extension {
  name = "mybase";
      ...
      (
        ...
        let
          ...
          assertionsModuleSystem =
            ...
            .${config.hosts.assertions.moduleSystem} or config.hosts.assertions.moduleSystem;
        in
        delib.module (
          {
            name = "hosts";
