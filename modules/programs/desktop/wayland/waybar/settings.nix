    ...
    let
      ...
      commonSettings = {
        ...
        "wlr/taskbar" = {
          format = "{icon}";
          icon-size = 32;
          icon-theme = myconfig.rice.icons.name;
        ...
        "custom/toggle-secondary" = {
          exec = "${homeconfig.home.homeDirectory}/waybar/scripts/monitor-toggle status -m ${monitors.secondary.output}";
          return-type = "json";
          exec-on-event = true;
          interval = "once";
          exec-if = "sleep 0.1";
          on-click = "${homeconfig.home.homeDirectory}/waybar/scripts/monitor-toggle toggle -m ${monitors.secondary.output} -p 2400x0 -s 1.6";
          format = "{}";
          tooltip = true;
        };
      };
